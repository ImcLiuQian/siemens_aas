...
import com.imc.service_cnc1.stateMachine.thread.FaultCheckThread;
...
public class ProStateMach implements InitializingBean {
    ...
    @SneakyThrows
    public void restart() {
        CNC1.uaClientService.writeNodeValue(CNC1NodeIds.initialFlag, true);
        Thread.sleep(10);
        CNC1.uaClientService.writeNodeValue(CNC1NodeIds.initialFlag, false);
        CNC1.uaClientService.writeNodeValue(CNC1NodeIds.startFlag, true);
    }
}
